...
export default function Carousel({cart,isOpen,onOpen, onClose}: any) {
      ...
      <div className="flex h-full">
        {slides.map((slide) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-linear-to-r from-[#140a05]/95 via-[#140a05]/85 to-[#140a05]/50"></div>

            {/* HEADER */}
            <div className="absolute top-0 left-0 w-full z-20">
              <Navbar cart={cart} onOpen={onOpen} />
            </div>
